...
use App\Models\ActividadExterna;
...
class ActividadExternaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Crear la actividad
        $actividad = ActividadExterna::create([
    ...
    {
        $actividades = ActividadExterna::all(); // Obtiene todas las actividades
    ...
    {
        $actividades = ActividadExterna::with(['poa.operaciones', 'usuario.area', 'usuario.unidad'])->get();
    ...
    {
        $actividad = ActividadExterna::findOrFail($id);
    ...
    {
        $actividad = ActividadExterna::with(['poa'])->findOrFail($id);
