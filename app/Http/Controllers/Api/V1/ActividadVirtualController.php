...
class ActividadVirtualController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Crear la actividad
        $actividad = ActividadVirtual::create([
    ...
    {
        $actividades = ActividadVirtual::all(); // Obtiene todas las actividades
    ...
    {
        $actividades = ActividadVirtual::with(['poa.operaciones', 'usuario.area', 'usuario.unidad'])->get();
    ...
    {
        $actividad = ActividadVirtual::findOrFail($id);
    ...
    {
        $actividad = ActividadVirtual::with(['poa'])->findOrFail($id);
